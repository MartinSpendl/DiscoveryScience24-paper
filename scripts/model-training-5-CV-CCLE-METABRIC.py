...
from sslcox.data.load_datasets import load_CCLE, load_METABRIC, load_scLUAD
...
if __name__ == '__main__':
    ...
    # Adding arguments
    parser.add_argument('--expressions', type=str, default='CCLE', choices=['CCLE', 'METABRIC'],
                        help='Dataset to use: CCLE, METABRIC')
    ...
    parser.add_argument('--latent-features', type=int, default=100, help='The number of latent features used')
    ...
    for expressions in ['CCLE', 'METABRIC']:
        main(args.expressions, args.hyper_parameter_optimization, args.override, args.latent_features)
